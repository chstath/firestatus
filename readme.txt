...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\firestatus on
     Windows, /home/user/dev/firestatus on Linux) in a file named
     firestatus@astithas.com and copy that file to
